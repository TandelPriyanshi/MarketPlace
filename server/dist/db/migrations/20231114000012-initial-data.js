...
module.exports = {
    up: async (queryInterface, Sequelize) => {
        ...
        const createOrUpdateUser = async (userData) => {
            const existingUser = await queryInterface.sequelize.query(`SELECT id FROM users WHERE id = :id`, {
        ...
        await createOrUpdateUser({
            ...
            password: await bcryptjs_1.default.hash('seller123', salt),
            firstName: 'Sample',
            lastName: 'Seller',
            phone: '+1234567891',
        ...
        // Seller profile
        const existingSeller = await queryInterface.sequelize.query(`SELECT id FROM sellers WHERE id = :id`, {
        ...
        await createOrUpdateUser({
            ...
            password: await bcryptjs_1.default.hash('delivery123', salt),
            firstName: 'Delivery',
            lastName: 'Person',
            phone: '+1234567892',
        ...
        const existingDeliveryPerson = await queryInterface.sequelize.query(`SELECT id FROM delivery_persons WHERE id = :id`, {
        ...
        await createOrUpdateUser({
            ...
            password: await bcryptjs_1.default.hash('salesman123', salt),
            firstName: 'Salesman',
            lastName: 'User',
            phone: '+1234567893',
        ...
        // Salesman profile
        const existingSalesman = await queryInterface.sequelize.query(`SELECT id FROM salesmen WHERE id = :id`, {
        ...
        await createOrUpdateUser({
            ...
            password: await bcryptjs_1.default.hash('customer123', salt),
            firstName: 'John',
            lastName: 'Doe',
            phone: '+1234567894',
